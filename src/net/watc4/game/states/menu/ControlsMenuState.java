...
public class ControlsMenuState extends MenuState {
	...
	private int[] actions = {P_LEFT, P_RIGHT, P_UP, P_DOWN, P_JUMP, L_LEFT, L_RIGHT, L_UP, L_DOWN};
	private String[] texts = {"P_LEFT : ", "P_RIGHT : ", "P_UP : ", "P_DOWN : ", "P_JUMP : ", "L_LEFT : ", "L_RIGHT : ", "L_UP : ", "L_DOWN : "};
